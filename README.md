...
> AI 가 사용자의 컨디션과 일정을 분석하여 맞춤형 홈케어 루틴을 제공하는 개인화 홈 웰니스 서비스

## 📖 서비스 소개

Stay:Care는 **사용자의 컨디션과 일정을 기반으로 맞춤형 홈케어 루틴을 제공하는 AI 개인화 홈 웰니스 서비스**입니다.

단순히 정해진 시간에 반복적으로 알림을 보내는 기존 웰니스 앱과 달리, **1분 자가 진단, 당일 피부 상태, 개인 캘린더 일정**을 종합적으로 분석하여 지금 가장 필요한 맞춤형 미션을 제안합니다.

- **1분 자가 진단**을 통해 사용자의 기본 컨디션과 피부 타입 분석
- **7일 · 14일 · 21일 · 28일** 기간별 목표 코스를 통한 건강한 루틴 형성
- **당일 피부 상태 체크**를 반영하여 실시간 맞춤 미션 재구성
- **개인 캘린더**와 연동하여 중요한 일정 (D-Day) 에 맞춘 집중 케어
- **스탬프 지도**로 미션 진행 상황을 시각화하고 포인트 보상 제공
- 사용자의 피부 타입과 최근 컨디션을 기반으로 **맞춤형 홈케어 제품 추천**

Stay:Care는 사용자의 일상과 컨디션을 기반으로,
AI가 상황에 맞는 홈케어 미션을 제공하여 건강한 루틴을 부담 없이 이어갈 수 있도록 도와주는 개인 맞춤형 홈 웰니스 비서입니다.
...
| 🎯 **기간 별 목표 코스** | 7일, 14일, 21일, 28일 코스를 선택하여 사용자의 목적에 맞는 웰니스 루틴을 제공합니다. |
| 🧴 **당일 피부 상태 체크** | 건조함, 열감, 트러블, 자외선 노출, 음주 등 당일 피부 상태와 환경을 간단한 체크박스로 기록합니다. |
| 🤖 **AI 실시간 미션 재구성** | 당일 피부 상태와 개인 일정을 종합하여 현재 사용자에게 필요한 홈케어 미션을 실시간으로 재구성합니다. |
| 📅 **캘린더 연동** | 결혼식, 데이트, 미팅, 회식 등 주요 일정을 등록하고 일정에 맞춰 AI가 미션을 재구성합니다. |
